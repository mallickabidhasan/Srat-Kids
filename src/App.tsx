...
const ADMINS = [
  ...
  { name: 'আজিজুল ইসলাম ময়না', role: 'সার্বিক তত্ত্বাবধান, স্টার কিডস্', image: 'https://i.imgur.com/bD0Y9kr.jpeg' },
  { name: 'এ কে এম শরীফুজ্জামান', role: 'অফিস অ্যাডমিন, স্টার কিডস্', image: 'https://i.imgur.com/JnVQU7z.jpeg' },
];
...
const TEACHER_NAMES = [
  "হাসান স্যার", "সাদিক স্যার", "ময়না স্যার", "মেহেদী স্যার", "ফেরদৌস স্যার",
  "রবিউল স্যার", "মুজাহিদুল স্যার", "মাহাবুর স্যার", "তপন স্যার", "শাওন স্যার",
  "আলিফ স্যার", "তরিকুল স্যার", "এনামুল স্যার", "শরিফ স্যার (বাণিজ্য)", "বাবুল স্যার",
  "রাসেল স্যার", "আবিদ স্যার", "শরিফ স্যার", "পলাশ স্যার", "রায়হান স্যার",
  "বাশার স্যার", "সিয়াম স্যার", "শরিফুল স্যার", "রুহুল আমিন স্যার", "মনি স্যার",
  "মো: হাফিজুল স্যার", "রায়হান স্যার", "ইভা ম্যাডাম", "রাজু স্যার", "মাসুম স্যার",
  "শাহ-আলম স্যার", "শিমুল স্যার", "সানজিদা ম্যাডাম", "নূর নাহার ম্যাডাম", "আবির স্যার",
  "মো: জাহিদুল ইসলাম স্যার", "জি.এম. শহীদুল্যাহ স্যার", "রুবিনা ম্যাডাম", "সাদ্দাম স্যার", "মেহেদী স্যার",
  "লুৎফুন্নেসা ম্যাডাম", "হালিমা ম্যাডাম", "বজলু স্যার", "সোলায়মান স্যার", "মাসুদ স্যার",
  "রুবেল স্যার", "মামুন স্যার"
];

const TEACHER_MOBILES = [
  "০১৭১১-৬২৪৪৭৮/০১৭১২-২৬৬২৭৪", "০১৭১১-৩৬০৯৫৬/০১৭৬৩-৮৭০০৪৭", "০১৯২৬-২৩১৮৪৩/০১৭২৯-৬৪৪৬৬২", "০১৭৩৬-০৯৫৯২৫/০১৮১১-৬৫৯০৩৩", "০১৭১১-২৪০৬১৫",
  "০১৭৮১-৬৪৯১১৭", "০১৭১৭-৭১৭২৮২", "-", "-", "০১৩০৩-৪৮৬৬৪২",
  "০১৭২৭-২১৩৬০৯", "০১৭৯৯-৩৫৫৬০৬", "০১৯২৭-৮৯০২১৩", "০১৭২৪-৪৬৭৬৮৭", "-",
  "০১৫১৬-৩০৫৪৬২", "০১৮৫৪-০০৯৬০৩", "০১৭১২-৯৯৪৪৬২", "০১৯২৭-১৬৬২৮৮", "-",
  "০১৭১৪-৩০৩১৬৯", "০১৭২১-৩৯৩৯৫৩", "০১৭৮৬-০৪৬৪৬৬", "০১৭০৭-৯৩৫৩৮৩", "০১৯১৬-৫৬৬৮০৭",
  "০১৭৩৭-৮৭০৬২১", "০১৩১৪-৫৪৪৪৬৪/০১৫১৮-৬৮৩৩৭২", "০১৯৮৮-২৯০৬৮৮", "০১৭৮২-০৮৯৩২৫", "০১৯৩১-৪৩২৩৩২",
  "০১৭০৭-১৪৯৫৩৬", "০১৯৪৮-১০৮৭১৮", "০১৩২১-৯৪২৮৬৯", "০১৯৩৭-৩৬৮৭৭৯", "০১৯৪৬-৫৪৫১৫৭",
  "০১৯৩৯-১২১৪৩৬", "০১৯১৭-২৯৩০২১", "-", "০১৬৪১-৫৩৪২৬১", "০১৭৪২-২৮৮৬৫২",
  "০১৭৬০-১৮৪৭৫৪", "০১৭৩৮-৩০১৩৮৯", "০১৩০৯-৬৫৪৭৪৫", "০১৭৫৬-৫৩৬৮০৩", "০১৭৯৪-৪৯৫৮০৯/০১৫৭১-৪৬৮০৭৪",
  "০১৯৬২-০৫১৬৮৮", "০১৫৭১-৩৭৮৯৬১"
];

const TEACHER_SUBJECTS = [
  "পরিচালক", "যুগ্ম পরিচালক", "ইংরেজি", "পদার্থ/ গণিত", "গণিত",
  "ইংরেজি", "বাংলা", "রসায়ন", "বাংলা", "ইংরেজি",
  "দশম", "দশম", "নবম", "অষ্টম", "অষ্টম",
  "অষ্টম", "অষ্টম", "সপ্তম", "সপ্তম", "সপ্তম",
  "ষষ্ঠ", "ক্যাডেট", "ক্যাডেট", "ক্যাডেট", "পঞ্চম",
  "পঞ্চম", "পঞ্চম", "পঞ্চম", "পঞ্চম", "চতুর্থ",
  "চতুর্থ", "চতুর্থ", "চতুর্থ", "চতুর্থ", "চতুর্থ",
  "তৃতীয়", "তৃতীয়", "তৃতীয়", "তৃতীয়", "দ্বিতীয়",
  "দ্বিতীয়", "দ্বিতীয়", "দ্বিতীয়", "প্রথম", "কম্পিউটার অপারেটর",
  "কম্পিউটার অপারেটর", "কম্পিউটার অপারেটর", "অফিস সহায়ক"
];

const TEACHER_LIST_DATA = Array.from({ length: 51 }, (_, i) => ({
  id: i + 1,
                  ...
                  {teacher.mobile === '-' ? '-' : 
                    teacher.mobile.split('/').map((num, idx, arr) => (
                      <React.Fragment key={idx}>
                        <a 
                          href={`tel:${convertBengaliToStandard(num.replace(/-/g, ''))}`} 
            ...
            >
              <div className="bg-blue-900 p-8 sm:p-10 text-white flex justify-between items-center">
                <div>
                  ...
                  <p className="text-blue-200 font-bold mt-2">Total Teachers: 51</p>
                </div>
                <button 
                  onClick={() => setShowAll(false)} 
...
const VisitorCounter = () => {
  ...
  const classData = [
    { class: "১ম শ্রেণী", count: "০০" },
    { class: "২য় শ্রেণী", count: "০০০" },
    { class: "৩য় শ্রেণী", count: "০০০" },
    { class: "৪র্থ শ্রেণী", count: "০০০" },
    { class: "৫ম শ্রেণী", count: "০০০" },
    { class: "৬ষ্ঠ শ্রেণী", count: "০০" },
    { class: "৭ম শ্রেণী", count: "০০০" },
    { class: "৮ম শ্রেণী", count: "০০০" },
    { class: "৯ম শ্রেণী", count: "০০০" },
    { class: "১০ম শ্রেণী", count: "০০০" },
    { class: "ক্যাডেট", count: "০০" },
  ];
